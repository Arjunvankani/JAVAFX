...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        grid.getChildren().addAll(nameLabel, nameInput, passLabel, passInput, ageLabel, ageInput,checkLabel, box1, box2,choiceLabel,choiceBox,comboLabel,comboBox,listLabel,listView, loginButton);

        Scene scene = new Scene(grid, 840, 520);
